...
- Done Installations Source source 
 - Thanks For your use Source source
 ══════════════════════════════    
...
io.popen("mkdir source_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls source_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."source:Sudo:User", msg.sender_user_id_) 
if hash or Devsource(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."source:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Devsource(msg) or DevBot(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."source:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Devsource(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."source:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or Devsource(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."source:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or Devsource(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."source:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Devsource(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
...
function Vips(msg)
local hash = database:sismember(bot_id.."source:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or Devsource(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."source:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."source:Basic:Constructor"..chat_id, user_id) then
var = true                 
elseif database:sismember(bot_id.."source:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."source:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."source:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."source:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."source:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
var = "البوت"
elseif database:sismember(bot_id.."source:Sudo:User", user_id) then
var = database:get(bot_id.."source:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."source:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."source:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."source:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."source:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."source:Manager"..chat_id, user_id) then
var = database:get(bot_id.."source:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."source:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."source:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."source:MN:TF"..chat_id, user_id) then
var =  "منظف"  
elseif database:sismember(bot_id.."source:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."source:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."source:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."source:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."source:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."source:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."source:GBan:User",User_id) then
Var = true
else
Var = false
end
...
local UserName = (data.username_ or "sourceTEAM")
for source in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = source
end
...
database:sadd(bot_id..'source:Chek:Groups',idg) 
database:set(bot_id.."source:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'source:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."source:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."source:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."source:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."source:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."source:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function source_Files(msg)
for v in io.popen('ls source_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("source_Files/"..v)
if plugin.source and msg then
pre_msg = plugin.source(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function source_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'source:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'source:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
...
database:set(bot_id..'source:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'source:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'source:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."source:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."source:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."source:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."source:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."source:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."source:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."source:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."source:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."source:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."source:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."source:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."source:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."source:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."source:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."source:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."source:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."source:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."source:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."source:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."source:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."source:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."source:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."source:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."source:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."source:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."source:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."source:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."source:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."source:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"⌔ ⍒ تم الغاء حفظ الرابط")       
database:del(bot_id.."source:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."source:Private:Group:Link"..msg.chat_id_,Link)
...
local list = database:smembers(bot_id..'source:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
local source_Msg = database:get(bot_id.."source:Add:Filter:Rp2"..text..msg.chat_id_)   
if source_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","⌔ ⍒ "..source_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."source:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء الامر ✖️" then   
send(msg.chat_id_, msg.id_,"⌔ ⍒  تم الغاء حفظ اسم البوت") 
database:del(bot_id.."source:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."source:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."source:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "⌔ ⍒  تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."source:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."source:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"⌔ ⍒ ارسل الامر الجديد")  
database:del(bot_id.."source:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."source:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."source:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."source:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."source:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."source:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"⌔ ⍒ تم حفظ الامر")  
database:del(bot_id.."source:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."source:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."source:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."source:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."source:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."source:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."source:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."source:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."source:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."source:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."source:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."source:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'source:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."source:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."source:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."source:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."source:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."source:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."source:lockpin"..msg.chat_id_)  
database:srem(bot_id.."source:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."source:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."source:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'source:'..lock..msg.chat_id_)    
end
...
database:del(bot_id.."source:Lock:Link"..msg.chat_id_)  
...
database:del(bot_id.."source:Lock:User:Name"..msg.chat_id_)  
...
database:del(bot_id.."source:Lock:Animation"..msg.chat_id_)  
...
database:del(bot_id.."source:Lock:Sticker"..msg.chat_id_)  
...
database:del(bot_id.."source:Lock:Contact"..msg.chat_id_)  
...
database:hset(bot_id.."source:flooding:settings:"..msg.chat_id_ ,"flood","kick")  
...
database:hset(bot_id.."source:flooding:settings:"..msg.chat_id_ ,"flood","del")  
...
database:hset(bot_id.."source:flooding:settings:"..msg.chat_id_ ,"flood","keed")  
...
database:hset(bot_id.."source:flooding:settings:"..msg.chat_id_ ,"flood","mute")  
...
database:hdel(bot_id.."source:flooding:settings:"..msg.chat_id_ ,"flood")  
Reply_Status(msg,msg.sender_user_id_,"unlock","⌔ ⍒ تم فـتح التكرار")
return false
end

if text == ("مسح قائمه العام") and Devsource(msg) then
database:del(bot_id.."source:GBan:User")
send(msg.chat_id_, msg.id_, "\n⌔ ⍒ تم مـسح قائمه العام")
return false
end
if text == ("مسح المطورين") and Devsource(msg) then
database:del(bot_id.."source:Sudo:User")
send(msg.chat_id_, msg.id_, "\n⌔ ⍒  تم مـسح قائمة المطورين  ")
end
if text == "مسح المنشئين الاساسين" and DevBot(msg) then
database:del(bot_id.."source:Basic:Constructor"..msg.chat_id_)
...
database:del(bot_id.."source:Constructor"..msg.chat_id_)
...
database:del(bot_id.."source:Manager"..msg.chat_id_)
...
database:del(bot_id.."source:Mod:User"..msg.chat_id_)
...
database:del(bot_id.."source:Special:User"..msg.chat_id_)
...
database:del(bot_id.."source:Muted:User"..msg.chat_id_)
...
database:del(bot_id.."source:Ban:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "\n⌔ ⍒ تم مـسح المحظورين")
end
if text == ("قائمه العام") and Devsource(msg) then
local list = database:smembers(bot_id.."source:GBan:User")
t = "\n⌔ ⍒ قائمة المحظورين عام \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
...
if text == ("المطورين") and Devsource(msg) then
local list = database:smembers(bot_id.."source:Sudo:User")
t = "\n⌔ ⍒ قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."source:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."source:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."source:Constructor"..msg.chat_id_)
t = "\n⌔ ⍒ قائمة المنشئين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."source:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."source:Manager"..msg.chat_id_)
t = "\n⌔ ⍒ قائمة المدراء \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."source:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."source:Mod:User"..msg.chat_id_)
t = "\n⌔ ⍒ قائمة الادمنيه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."source:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."source:Muted:User"..msg.chat_id_)
t = "\n⌔ ⍒ قائمة المكتومين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."source:User:Name" .. v)
if username then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and Devsource(msg) then
...
database:sadd(bot_id.."source:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and Devsource(msg) then
...
database:sadd(bot_id.."source:GBan:User", result.id_)
Reply_Status(msg,result.id_,"reply","⌔ ⍒ تم حظره عام من المجموعات")  
else
send(msg.chat_id_, msg.id_,"⌔ ⍒ لا يوجد حساب بهاذا المعرف")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_source, nil)
return false
end
if text and text:match("^حظر عام (%d+)$") and Devsource(msg) then
...
database:sadd(bot_id.."source:GBan:User", userid)
Reply_Status(msg,userid,"reply","⌔ ⍒ تم حظره عام من المجموعات")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and Devsource(msg) then
function Function_source(extra, result, success)
database:srem(bot_id.."source:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","⌔ ⍒ تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_source, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and Devsource(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_source(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","⌔ ⍒ تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."source:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"⌔ ⍒ لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and Devsource(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."source:GBan:User", userid)
Reply_Status(msg,userid,"reply","⌔ ⍒ تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Devsource(msg) then
function Function_source(extra, result, success)
database:sadd(bot_id.."source:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","⌔ ⍒ تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_source, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and Devsource(msg) then
...
database:sadd(bot_id.."source:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and Devsource(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."source:Sudo:User", userid)
Reply_Status(msg,userid,"reply","⌔ ⍒ تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Devsource(msg) then
function Function_source(extra, result, success)
database:srem(bot_id.."source:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","⌔ ⍒ تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_source, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and Devsource(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_source(extra, result, success)
if result.id_ then
database:srem(bot_id.."source:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and Devsource(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."source:Sudo:User", userid)
...
function Function_source(extra, result, success)
database:sadd(bot_id.."source:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."source:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."source:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_source(extra, result, success)
database:srem(bot_id.."source:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_source(extra, result, success)
if result.id_ then
database:srem(bot_id.."source:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."source:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_source(extra, result, success)
database:srem(bot_id.."source:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","⌔ ⍒ تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_source, nil)
end
...
function Function_source(extra, result, success)
if result.id_ then
database:srem(bot_id.."source:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","⌔ ⍒ تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"⌔ ⍒ لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."source:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","⌔ ⍒ تم تنزيله من المنشئين")  
end
...
function Function_source(extra, result, success)
database:srem(bot_id.."source:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_source(extra, result, success)
if result.id_ then
database:srem(bot_id.."source:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."source:Manager"..msg.chat_id_, userid)
...
function Function_source(extra, result, success)
database:srem(bot_id.."source:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_source(extra, result, success)
if result.id_ then
database:srem(bot_id.."source:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."source:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."source:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local sourcert = database:get(bot_id.."source:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if sourcert == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n⌔ ⍒ العضو ›› ["..data.first_name_.."](t.me/"..(data.username_ or "NUMNUMH")..")".."\n⌔ ⍒ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."source:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."source:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif sourcert == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n⌔ ⍒ العضو ›› ["..data.first_name_.."](t.me/"..(data.username_ or "NUMNUMH")..")".."\n⌔ ⍒ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."source:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."source:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif sourcert == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n⌔ ⍒ العضو ›› ["..data.first_name_.."](t.me/"..(data.username_ or "NUMNUMH")..")".."\n⌔ ⍒ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."source:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."source:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif sourcert == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n⌔ ⍒ العضو ›› ["..data.first_name_.."](t.me/"..(data.username_ or "NUMNUMH")..")".."\n⌔ ⍒ تم رفعه "..RTPA.." هنا\n")   
end
end,nil)   
end   
...
database:srem(bot_id.."source:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."source:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif sourcert == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n⌔ ⍒ العضو ›› ["..data.first_name_.."](t.me/"..(data.username_ or "NUMNUMH")..")".."\n⌔ ⍒ تم تنزيله من "..RTPA.." هنا\n")   
database:srem(bot_id.."source:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."source:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."source:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local sourcert = database:get(bot_id.."source:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if sourcert == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n⌔ ⍒ العضو ›› ["..result.title_.."](t.me/"..(text1[3] or "NUMNUMH")..")".."\n⌔ ⍒ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."source:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."source:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif sourcert == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n⌔ ⍒ العضو ›› ["..result.title_.."](t.me/"..(text1[3] or "NUMNUMH")..")".."\n⌔ ⍒ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."source:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."source:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."source:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."source:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif sourcert == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n⌔ ⍒ العضو ›› ["..result.title_.."](t.me/"..(text1[3] or "NUMNUMH")..")".."\n⌔ ⍒ تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."source:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."source:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:srem(bot_id.."source:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."source:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."source:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."source:Muted:User"..msg.chat_id_, userid)
...
function Function_source(extra, result, success)
database:srem(bot_id.."source:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_source(extra, result, success)
if result.id_ then
database:srem(bot_id.."source:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."source:Muted:User"..msg.chat_id_, userid)
...
database:set(bot_id..'source:source:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","⌔ ⍒ تم قفـل الفارسيه")  
end
if text and database:get(bot_id..'source:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'source:source:lock:Fshar'..msg.chat_id_) 
...
database:set(bot_id..'source:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","⌔ ⍒ تم قفـل الفشار")  
end
if text and database:get(bot_id..'source:source:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'source:lock:Fshar'..msg.chat_id_) 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌔ ⍒  العضو ›› ['..data.first_name_..'](t.me/'..(data.username_ or 'source')..') '
...
if database:sismember(bot_id.."source:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:hset(bot_id.."source:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."source:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
...
local status_Link = database:get(bot_id.."source:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"⌔ ⍒ جلب الرابط معطل") 
return false  
end
local link = database:get(bot_id.."source:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:del(bot_id.."source:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
database:sadd(bot_id.."source:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."source:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "⌔ ⍒ تم مـسح "..k.." من الميديا"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."source:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."source:allM"..msg.chat_id_)
...
database:set(bot_id.."source:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."source:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."source:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
local list = database:smembers(bot_id.."source:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."source:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."source:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."source:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⌔ ⍒ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local source_Msg = database:get(bot_id.."source:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ›› {"..source_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."source:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."source:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"⌔ ⍒ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."source:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."source:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."source:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."source:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"⌔ ⍒ تم منع الكلمه مع التحذير")  
database:del(bot_id.."source:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."source:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."source:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."source:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:set(bot_id.."source:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."source:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."source:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."source:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."source:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:get(bot_id.."source:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
...
if Addictive(msg) then
database:setex(bot_id.."source:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
local Set_Rules = database:get(bot_id.."source:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."source:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."source:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."source:List:Cmd:Group:New"..msg.chat_id_)
end
...
database:set(bot_id.."source:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
if Constructor(msg) then
database:set(bot_id.."source:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
database:del(bot_id.."source:MN:TF"..msg.chat_id_)
...
local list = database:smembers(bot_id.."source:MN:TF"..msg.chat_id_)
t = "\n⌔ ⍒ قائمة المنظفين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."source:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."source:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."source:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."source:Coomds"..msg.chat_id_)
end
...
database:del(bot_id.."source:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."source:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."source:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."source:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"⌔ ⍒  تم تغير رد المطور الى ›› "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."source:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"⌔ ⍒  تم تغير رد المنشئ الاساسي الى ›› "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."source:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"⌔ ⍒  تم تغير رد المنشئ الى ›› "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."source:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"⌔ ⍒  تم تغير رد المدير الى ›› "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."source:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"⌔ ⍒  تم تغير رد الادمن الى ›› "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."source:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"⌔ ⍒  تم تغير رد المميز الى ›› "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."source:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"⌔ ⍒  تم تغير رد العضو الى ›› "..Teext)
end


if text == ("مسح ردود المدير") and BasicConstructor(msg) then
local list = database:smembers(bot_id.."source:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."source:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."source:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."source:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."source:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."source:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."source:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."source:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."source:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."source:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."source:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."source:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
...
db = "فيديو 📹"
elseif database:get(bot_id.."source:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف 🗂️"
elseif database:get(bot_id.."source:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") ›› {"..db.."}\n"
end
...
local test = database:get(bot_id.."source:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."source:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."source:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."source:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."source:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."source:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."source:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."source:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."source:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."source:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."source:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."source:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
database:set(bot_id.."source:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."source:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '⌔ ⍒ الان ارسل الرد الذي تريد اضافته \n⌔ ⍒  قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n⌔ ⍒  يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات \n- قناه البوت @NUMNUMH')
database:set(bot_id.."source:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."source:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."source:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."source:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."source:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."source:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."source:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."source:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."source:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."source:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."source:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."source:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."source:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."source:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."source:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."source:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'source:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."source:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."source:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."source:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."source:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."source:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."source:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."source:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."source:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'source:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'source:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and Devsource(msg) then 
local list = database:smembers(bot_id.."source:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."source:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."source:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."source:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."source:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."source:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."source:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."source:Add:Rd:Sudo:File"..v)
database:del(bot_id.."source:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."source:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"⌔ ⍒ تم مـسح ردود المطور")
end
if text == ("ردود المطور") and Devsource(msg) then 
local list = database:smembers(bot_id.."source:List:Rd:Sudo")
text = "\n⌔ ⍒ قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."source:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."source:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
...
db = "فيديو 📹"
elseif database:get(bot_id.."source:Add:Rd:Sudo:File"..v) then
db = "ملف 🗂️"
elseif database:get(bot_id.."source:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") ›› {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."source:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."source:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."source:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."source:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."source:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."source:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."source:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."source:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."source:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."source:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."source:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"⌔ ⍒ تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد للكل" and Devsource(msg) then 
send(msg.chat_id_, msg.id_,"⌔ ⍒  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."source:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and Devsource(msg) then 
send(msg.chat_id_, msg.id_,"⌔ ⍒  ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."source:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."source:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '⌔ ⍒ الان ارسل الرد الذي تريد اضافته \n⌔ ⍒  قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n⌔ ⍒  يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."source:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."source:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."source:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."source:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"⌔ ⍒ تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'source:'..v..text)
end
database:del(bot_id.."source:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."source:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."source:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'source:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."source:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."source:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."source:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."source:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."source:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."source:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."source:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."source:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."source:Sudo:User",result.sender_user_id_) then
dev = "⌔ ⍒ تم تنزيله من المطورين"
else 
dev = "⌔ ⍒ هو ليس مطور" 
end
if database:sismember(bot_id.."source:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "⌔ ⍒ تم تنزيل من الاساسيين" 
else 
crr = "⌔ ⍒ هو ليس منشئ اساسي" 
end
if database:sismember(bot_id.."source:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "⌔ ⍒ تم تنزيله من المنشئين" 
else 
cr = "⌔ ⍒ هو ليس منشئ" 
end
if database:sismember(bot_id.."source:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "⌔ ⍒ تم تنزيله من المدراء" 
else 
own = "⌔ ⍒ هو ليس مدير" 
end
if database:sismember(bot_id.."source:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "⌔ ⍒ تم تنزيله من الادميه"
 else 
mod = "⌔ ⍒ هو ليس ادمن" 
end
if database:sismember(bot_id.."source:Special:User"..msg.chat_id_, result.sender_user_id_) then
...
database:srem(bot_id.."source:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."source:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."source:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."source:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."source:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."source:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."source:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."source:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."source:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."source:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."source:User:Name"..v.user_id_) then
t = t.."|"..x.."| -› [@"..database:get(bot_id.."source:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
if not database:get(bot_id.."source:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."source:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
...
database:set(bot_id.."source:Kick:Me"..msg.chat_id_,true)  
Text = "\n⌔ ⍒ تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
database:srem(bot_id.."source:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."source:Muted:User"..msg.chat_id_,result.id_)
usertext = "\n⌔ ⍒  العضو ›› ["..result.title_.."](t.me/"..(username or "NUMNUMH")..")"
status  = "\n⌔ ⍒  تم الغاء القيود عنه"
...
function Function_source(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."source:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."source:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."source:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_source(extra, result, success)
if database:sismember(bot_id.."source:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."source:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."source:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."source:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."source:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."source:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
if text == "تفعيل المغادره" and Devsource(msg) then   
database:del(bot_id.."source:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"⌔ ⍒ تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and Devsource(msg) then  
database:set(bot_id.."source:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "⌔ ⍒ تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."source:Name:Bot") or "كيان") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
'اهو شتريد 🤥؟',
'لابسك لتلح',
'شبيك حيوان لتلح وشترك بقناه البوت يلا [ @NUMNUMH ]',
'اريد ارتبط مليت',
'🤤عدكم حاته بلكروب ؟ بربك دز معرفها',
'اشو ماكو تفاعل ؟',
'يمعود لتلح النت خرا',
'روح صلي اليوم صليت؟',
'ما ارد على ناس معفنه',
}
...
if Devsource(msg) then
database:setex(bot_id.."source:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."source:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."source:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."source:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."source:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."source:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."source:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."source:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."source:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."source:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."source:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."source:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."source:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."source:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."source:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."source:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."source:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."source:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."source:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."source:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."source:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."source:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."source:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."source:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."source:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."source:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."source:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."source:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."source:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."source:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."source:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."source:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."source:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."source:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."source:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
database:set(bot_id.."source:Fun_Bots"..msg.chat_id_,"true")
end
...
database:del(bot_id..'source:Lock:ID:Bot'..msg.chat_id_) 
...
database:set(bot_id..'source:Lock:ID:Bot'..msg.chat_id_,true) 
...
database:del(bot_id..'source:Lock:ID:Bot:Photo'..msg.chat_id_) 
...
database:set(bot_id..'source:Lock:ID:Bot:Photo'..msg.chat_id_,true) 
...
database:setex(bot_id.."source:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
⌔ ⍒ ارسل الان النص
⌔ ⍒ يمكنك اضافه :
- `#username` > اسم المستخدم
...
setex:set(bot_id.."source:Set:klesh:id"..msg.chat_id_,Text_Rand)
...
if database:get(bot_id.."source:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"⌔ ⍒ تم الغاء تعين الايدي") 
database:del(bot_id.."source:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."source:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."source:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'⌔ ⍒ تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'source:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'source:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."source:Spam:Group"..msg.sender_user_id_,text) 
...
local get_id = database:get(bot_id.."source:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'source:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'source:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'source:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."source:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$")  and not database:get(bot_id..'source:Lock:ID:Bot'..msg.chat_id_) then
...
if text == 'السيرفر' and Devsource(msg) then 
...
⌔ ⍒ بيع مجوهراتي + العدد
••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••
⌔ ⍒ Ch TeAM -› [@source](t.me/NUMNUMH)
]]
send(msg.chat_id_, msg.id_,Teext) 
end
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'source:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '⌔ ⍒ عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'source:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."source:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."source:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and Devsource(msg) then
local pv = database:smembers(bot_id..'source:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'source:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and Devsource(msg) then
local group = database:smembers(bot_id..'source:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'source:Chek:Groups',group[i])  
w = w + 1
end
...
if text == ("تحديث السورس") and Devsource(msg) then  
...
------------------------------------------------------------------------
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."source:zhrf_Bots"..msg.chat_id_) == "open" then
...
ge = https.request('https://ahmedcg4.ml/Age.php?source='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.Age.YouAge)
end
if text and text:match("^معنى (.*)$") and database:get(bot_id.."source:nam_Bots"..msg.chat_id_) == "open" then
...
if text and text:match("^برج (.*)$") and database:get(bot_id.."source:abr_Bots"..msg.chat_id_) == "open" then
...
if text == 'تفعيل البوت الخدمي' and Devsource(msg) then  
database:del(bot_id..'source:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'⌔ ⍒ تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and Devsource(msg) then  
database:set(bot_id..'source:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'⌔ ⍒ تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and Devsource(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'source:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'⌔ ⍒  تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'source:Chek:Groups')  
...
for k,v in pairs(list) do   
NAME = 'source Chat'
ASAS = database:smembers(bot_id.."source:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."source:Constructor"..v)
MDER = database:smembers(bot_id.."source:Manager"..v)
MOD = database:smembers(bot_id.."source:Mod:User"..v)
link = database:get(bot_id.."source:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"source":"'..NAME..'",'
else
t = t..',"'..v..'":{"source":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'source:Text_Dev')
if Text_Dev then 
send(msg.chat_id_, msg.id_,Text_Dev)
else
local Name = '⌔ ⍒ مطور البوت  : [ '@KKKKWT' ] 
⌔ ⍒ قناه البوت   : [ '@NUMNUMH' ] '
sendText(msg.chat_id_,Name,msg.id_/2097152/0.5,'md')
end
end
if text == 'الملفات' and Devsource(msg) then
t = '⌔ ⍒ جميع الملفات : \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls source_Files'):lines() do
if v:match(".lua$") then
...
if Devsource(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ArMoFX/files_source/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n*⌔ ⍒ اهلا بك في متجر ملفات source*\n*⌔ ⍒ يوجد في المتجر جميع ملفات السورس *\n*⌔ ⍒ الملفات الموجوده حاليا ↓ *\n*ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ*\n\n"
local TextE = "*ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ*\n*⌔ ⍒ تعني علامة (√) الملف مفعل*\n".."*⌔ ⍒ تعني علامة (×) الملف معطل*\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("source_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and Devsource(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("source_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/ArMoFX/files_source/master/files_source/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and Devsource(msg) then
...
if text == "مسح جميع الملفات" and Devsource(msg) then
os.execute("rm -fr source_Files/*")
send(msg.chat_id_,msg.id_,"⌔ ⍒ تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and Devsource(msg) then
local Users = database:smembers('source:'..bot_id.."userss")
local Groups = database:smembers('source:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'source:Chek:Groups',Groups[i])  
end
for i = 1, #Users do
database:sadd(bot_id..'source:UsersBot',Users[i])  
end
...
if text == "تحديث" and Devsource(msg) then
dofile("source.lua")  
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'source:Free:Add:Bots') then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if Devsource(msg) then
local Text = '*
قناه البوت [ @NUMNUMH ] ⌔ ⍒  مرحبا بك في اوامر المطور الجاهزه*'
local keyboard = {
{'الاحصائيات 📉'},
...
if not database:get(bot_id..'source:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'source:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not Devsource(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if Devsource(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == "تفعيل الاشتراك 🔭" and Devsource(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك 📠" and Devsource(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⌔ ⍒ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 🗳️" and Devsource(msg) then  
...
if text == ("المطورين 🛡️") and Devsource(msg) then
local list = database:smembers(bot_id.."source:Sudo:User")
t = "\n⌔ ⍒ قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."source:User:Name" .. v)
...
database:srem(bot_id..'source:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
if text and not database:sismember(bot_id..'source:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'source:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'source:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."source:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."source:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."source:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."source:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
...
database:del(bot_id.."source:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."source:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."source:Name:Bot") or "كيان")
if not database:get(bot_id.."source:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
source_Started_Bot(msg,data)
source_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'source:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."source:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
local list = database:smembers(bot_id.."source:Basic:Constructor"..msg.chat_id_)
...
if database:get(bot_id.."source:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."source:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."source:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."source:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local source_Msg = database:get(bot_id.."source:Add:Filter:Rp2"..text..result.chat_id_)   
if source_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","⌔ ⍒ "..source_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'source:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'source:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'source:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'source:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'source:Chek:Groups',v)  
end
...
database:sadd(bot_id..'source:Chek:Groups',v)  
end end,nil)
